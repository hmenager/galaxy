...
class ToolModule( WorkflowModule ):
    ...
    def __init__( self, trans, tool_id, tool_version=None, exact_tools=False, tool_hash=None ):
        self.trans = trans
    ...
    def from_dict( Class, trans, d, **kwds ):
        ...
        module = Class( trans, tool_id, tool_version=tool_version, exact_tools=exact_tools, tool_hash=tool_hash )
